...
function rand!(rng::AbstractRNG, v::AbstractVector, lmm::LMM{T}, theta) where T
...
rand!(v::AbstractVector, lmm::LMM, theta) = rand!(default_rng(), v::AbstractVector, lmm, theta)
"""
...
function rand!(rng::AbstractRNG, v::AbstractVector, lmm::LMM{T}, theta, beta) where T
...
rand!(v::AbstractVector, lmm::LMM, theta, beta) = rand!(default_rng(), v::AbstractVector, lmm, theta, beta)
